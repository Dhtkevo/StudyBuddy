...
namespace CourseManagement.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(StudyBuddyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Subject,Description")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Subject,Description")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
